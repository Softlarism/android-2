...
public class Alarma extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.alarma, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // A COMUNIDAD
        View btnSiguiente = view.findViewById(R.id.btn_menu_community);
        ...
        // A PERFIL
        View btnSiguiente3 = view.findViewById(R.id.btn_menu_account);
